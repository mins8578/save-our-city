...
---
향후 지속적으로 개발 할 프로젝트입니다. 
현재 강원도 지역 중 소멸도가 높은 3곳을 대상으로 진행하였지만 강원도 전역을 대상으로 하여 사이즈를 더 넓힐 계획이며 소멸 데이터 통계를 분석하여 실용성 있는 프로젝트로 넓힐 계획입니다.

추후에 개선할 사항
- 강원도 전역을 대상으로 한 소멸 위험도 분석
- 강원도 전역 지자체별 대응 정책 제시
- 소멸 위험도 순으로 정리 및 지역별 소멸 연도 예측 서비스
